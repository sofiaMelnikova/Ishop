    ...
    <form enctype="multipart/form-data" action="/saveChangeProduct" method="post">
        ...
        <div class="form-group">
            ...
            <select name="kind" class="form-control" id="exampleFormControlSelect1">
                <option value="1" {% if product.kinds_value == 'shoes' %} selected {% else %} disabled {% endif %}>Shoes</option>
                <option value="2" {% if product.kinds_value == 'jacket' %} selected {% else %} disabled {% endif %}>Jacket</option>
                <option value="3" {% if product.kinds_value == 'plaid' %} selected {% else %} disabled {% endif %}>Plaid</option>
            </select>
        </div>
